    ...
    if (fixResult.exitCode == 0) {
      ...
      try {
        ...
        if (flutterGetResult.exitCode == 0) {
          ...
          flutterGetProgress.fail('Failed to install/update Flutter packages!');
        }
      } catch (e) {
        flutterGetProgress
            .fail('Error occurred while running "flutter pub get": $e');
      }
    } else {
      fixSyntaxProgress.fail('Failed to fix all syntax violations!');
    }
  } catch (e) {
    fixSyntaxProgress
        .fail('Error occurred while running "dart fix --apply": $e');
  }
}
